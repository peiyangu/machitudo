...
const allStoresData = [
  ...
  },
  {
    name: "芋ぴっぴ。キッチンカー熊本",
    boothNumber: "70",
    description: "\nちょこっとケンピ/焼き芋ブリュレ焼き芋ハニーバター/焼き芋アイス/1ミリ絹糸の紫芋とアイス/蜜芋プリン/蜜芋モンブラン/蜜芋バスクチーズケーキ\n",
    image: "",
  ...
  },
  {
    name: "鉄鍋麻婆豆腐専門店　想一",
    boothNumber: "74",
    description: "麻婆豆腐/シャカシャカポテト/えびせん/生ビール/ハイボール\nレモンサワー",
    image: "",
  ...
  },
  {
    name: "くじびきREN",
    boothNumber: "158",
    description: "お子さま向けハズレなしおもちゃくじ\nポケカ＆ワンピカードくじ\n宝石すくい\n特価にてスペースがありましたら/お子さま用ポーチ等の販売",
    image: "",
  ...
  },
  {
    name: "Age-R-",
    boothNumber: "201",
    description: "布小物（ポーチやバッグ）\n\nワークショップ（アイロンビーズによるお名前プレート）",
    image: "",
  ...
  },
  {
    name: "green bear",
    boothNumber: "215",
    description: "ワークショップ\n◆キャンドルワーク\n瓶にロウのブロックを入れるだけの簡単なワークで/飾っても可愛い/灯しても可愛い癒しのキャンドルが出来ます\n◆ぷよぷよワーク(greenbearオリジナル)\n瓶にぷよぷよボールとパーツとキラキラ素材を入れ/瓶の下からライトアップして見て楽しむ可愛いアイテムが作れます",
    image: "",
