...
const allStoresData = [
  ...
  {
    name: "Fine Smile",
    description: "カルビ丼、カルビ焼きそば、牛串、豚串、豚たん串、フランクフルト、唐揚げ、コロッケ、フライドポテト、もつ鍋、ホットドッグ、飲み物、生ビール、果実酎ハイ（キウイ、いちご、夏みかん、他）",
    image: "",
  ...
  },
  {
    ...
    description: "炭火焼きスペアリブ炭火焼きソーセージビールノンアルコールビール",
    image: "",
  ...
  {
    name: "フォリボーラ",
    description: "フォリボーラハンバーガー無添加ベーコンバーガーブリックチーズバーガーフォリボーラスペシャル、ベーコンチーズバーガー",
    image: "",
  ...
  {
    name: "太陽フーズ",
    description: "佐賀牛ステーキ串　カルビステーキ串豚バラステーキ串　塩タンステーキ串佐賀牛焼きそば",
    image: "",
  ...
  {
    name: "芋ぴっぴ。キッチンカー熊本",
    description: "ちょこっとケンピ　　　250円焼き芋ブリュレ　　　　680円焼き芋ハニーバター　　680円焼き芋アイス　　　　　680円1ミリ絹糸の紫芋とアイス　1300円蜜芋プリン480円蜜芋モンブラン420円蜜芋バスクチーズケーキ500円",
    image: "",
  ...
  {
    name: "hugcoffee",
    description: "コーヒー・カフェオレ・コーヒー牛乳・抹茶ラテ・ほうじ茶ラテ・和紅茶ラテ、チャイ・ココア、マンゴーラッシー・レモネード・レモンスカッシュコーヒー豆・ドリップバックなどのコーヒー物販どら焼き・焼き菓子hugcoffeeオリジナルグッズ画像に載せる場合は、スペシャルティコーヒーやスペシャルティコーヒーを原料にした様々なドリンク、またhugcoffeeのオリジナルグッズをおもちします。発送や梱包の関係でどこまでできるか検討中です。なんでもできるように申請はしておきますので、何卒ご理解いただけますと幸いです。",
    image: "",
  ...
  {
    name: "green bear",
    description: "ワークショップ◆キャンドルワーク瓶にロウのブロックを入れるだけの簡単なワークで、飾っても可愛い、灯しても可愛い癒しのキャンドルが出来ます◆ぷよぷよワーク(greenbearオリジナル)瓶にぷよぷよボールとパーツとキラキラ素材を入れ、瓶の下からライトアップして見て楽しむ可愛いアイテムが作れます",
    image: "",
  ...
  {
    name: "ちくちく",
    description: "ミシン刺繍したオリジナルのパーツを貼ってネームタグやキーホルダーを作るワークショップをします。可愛い柄やユニークな柄の生地で作ったいろんなサイズのポーチやバッグなどの販売もします。",
    image: "",
  ...
  {
    name: "くじびきREN",
    description: "お子さま向けハズレなしおもちゃくじポケカ＆ワンピカードくじ宝石すくい特価にてスペースがありましたら、お子さま用ポーチ等の販売",
    image: "",
  ...
  {
    name: "SUSIE",
    description: "全国の約40名の作家によるハンドメイド雑貨＆セレクト雑貨　(編み物、布小物、麻、本革、キッズ用品、ベビー用品など)  プレゼントにもオススメの1点ものが見つかります♪",
    image: "",
  ...
  },
  {
    ...
    description: "レザークラフト男性向け・女子向けアクセサリー小物キャンプギア等",
    image: "",
